<template lang="html">
  <div class="">
    <el-breadcrumb class="bread-wrapper" separator="/">
      ...
      <el-breadcrumb-item>城市攻略列表</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="list-wrapper">
      ...
      <router-link class="button-create" :to="{ name: 'CityGuid', params: { id: 'create' }}"><el-button type="primary">新建城市攻略</el-button></router-link>
      <el-card class="list-item" v-for="(item, index) in list" :key="index" :body-style="{ padding: '0px' }">
        ...
        <div class="list-info" style="padding: 14px;">
          ...
          <div class="bottom">
            <router-link :to="{ name: 'CityGuid', params: { id: item._id }}"><el-button type="text" class="button">编辑</el-button></router-link>
