<template lang="html">
  <div class="">
    <el-breadcrumb class="bread-wrapper" separator="/">
      ...
      <el-breadcrumb-item :to="{ name: 'CityGuids' }">城市攻略</el-breadcrumb-item>
      <el-breadcrumb-item>{{ type === 'create' ? '添加': '编辑'}}城市攻略</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span>{{ type === 'create' ? '添加': '编辑'}}城市攻略</span>
      </div>
      <el-form ref="form" :model="form" :rules="rules" label-width="130px" label-position="top">
        ...
        <el-form-item label="关于编者" prop="reason">
...
export default {
  ...
  async created () {
    ...
    // if (!restaurantData) {
    const restaurantData = await this.getRecommend({ id, editor: 0 })
    // }
